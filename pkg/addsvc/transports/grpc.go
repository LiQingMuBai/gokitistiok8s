...
func encodeGRPCSumResponse(_ context.Context, grpcReply interface{}) (res interface{}, err error) {
	...
	return &pb.SumReply{Rs: reply.Rs}, grpcEncodeError(errors.Cast(reply.Err))
}
...
func encodeGRPCConcatResponse(_ context.Context, grpcReply interface{}) (res interface{}, err error) {
	...
	return &pb.ConcatReply{Rs: reply.Rs}, grpcEncodeError(errors.Cast(reply.Err))
}
...
func NewGRPCClient(conn *grpc.ClientConn, otTracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer, logger log.Logger) service.AddsvcService {
